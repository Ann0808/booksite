...
var items = document.querySelectorAll("#carouselPurchased"+' .carousel__item'); // массив перелистывающихся элементов
var len = items.length; // количество элементов
var parent = document.querySelector("#carouselPurchased"+'.carousel'); // родитель карусели
